    ...
    function drawTabular(){
        ...
        <script>
            ...
            function editRow(param){
                ...
                window.location.href='".$this->HTTP_URL.$curr_url_edit."&".$this->unique_prefix."rid='+selected_rid;
                return true;
            }
            ...
            function verifyDelete(param){
                ...
                if(confirm('Are you sure you want to delete this record?')){
                    window.location.href='".$this->HTTP_URL.$curr_url_delete."&".$this->unique_prefix."rid='+selected_rid;
                } else {
